...
class TestAPIBaseSetup(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.contabilidade = Contabilidade.objects.create(
            ...
            razao_social='Contabilidade API LTDA',
            cnpj='77777777000177',
            endereco='Rua API, 500',
            telefone='(31) 3333-0070',
            email='api@contabilidade.com',
            responsavel='Responsável API',
        )
        ...
        cls.imobiliaria = Imobiliaria.objects.create(
            ...
            cnpj='88888888000188',
            telefone='(31) 3333-0071',
            email='api@imobiliaria.com',
            responsavel_financeiro='Responsável Financeiro API',
        )
        ...
        cls.comprador = Comprador.objects.create(
            ...
            tipo_pessoa='PF',
            cpf='999.999.999-98',
            telefone='(31) 3333-0072',
            celular='(31) 99999-0072',
        ...
        # Criar algumas parcelas (only if not auto-generated by save())
        ...
        # Mark first 3 auto-generated parcelas as paid
