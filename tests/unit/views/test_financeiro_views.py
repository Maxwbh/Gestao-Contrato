...
def contrato_com_parcelas_ciclo_2(contrato_factory):
    """Cria um contrato com parcelas do ciclo 2 (parcela 13+) e reajuste pendente"""
    from financeiro.models import Parcela
    from dateutil.relativedelta import relativedelta

    # Contract from 13 months ago so cycle 2 reajuste date is in the past and thus blocked
    ...
    # Only create parcelas not auto-generated by contrato.save()
