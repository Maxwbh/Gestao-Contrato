...
| HU-23 | `ArquivoRemessa`, `ItemRemessa`, `ContaBancaria` | `CNABService` | `/financeiro/remessa/`, `/financeiro/remessa/gerar/`, `/financeiro/remessa/<pk>/download/`, `/financeiro/remessa/<pk>/marcar-enviada/`, `/financeiro/remessa/historico/` |
