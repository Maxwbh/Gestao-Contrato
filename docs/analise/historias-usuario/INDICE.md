...
| HU-27 | *(navegação — sem modelos)* | — | **Menu** (`templates/base.html`): novo dropdown "Cobrança" (hub + passo a passo + acompanhamento) e "Financeiro" enxuto; reagrupa links existentes (📋 especificada) |
